...
while True:
    ...
    if True:
        ...
        print("Please select which sheet do you want to insert Image\n")

        # 建立使用者 GUI，使其可選擇要導入 Image 的工作表
        windowWS = tk.Tk()
        windowWS.title("Sheet select")
        ...
        labelTop = tk.Label(windowWS, text = "Please select the sheet you want to insert Image")
        ...
        labelChoose = tk.Label(windowWS, text="selected sheet is: ")
        ...
        start_buttonWS = tk.Button(button_frameWS, text="OK", width=6, command=windowWS.destroy)
        start_buttonWS.grid(column=0, row=0, padx=8)
        exit_buttonWS = tk.Button(button_frameWS, text="Close", width=6, command=exit_)
        exit_buttonWS.grid(column=1, row=0, padx=8)

        windowWS.mainloop()

        print("Selected: ", comboboxWSText.get(), "\n")
        print("========================================\n")
        ...
        image_label1 = tk.Label(image_frame1, text="Image path1")
        ...
        image_label2 = tk.Label(image_frame2, text="Image path2")
        ...
        image_button2 = tk.Button(image_frame2, text="Select", command=selectFolderPath2)
        ...
        image_label3 = tk.Label(image_frame3, text="Image path3")
        ...
        image_button3 = tk.Button(image_frame3, text="Select", command=selectFolderPath3)
        ...
        image_label4 = tk.Label(image_frame4, text="Image path4")
        ...
        image_button4 = tk.Button(image_frame4, text="Select", command=selectFolderPath4)
        ...
        image_label5 = tk.Label(image_frame5, text="Image path5")
        ...
        image_button5 = tk.Button(image_frame5, text="Select", command=selectFolderPath5)
        ...
        image_label6 = tk.Label(image_frame6, text="Image path6")
        ...
        image_button6 = tk.Button(image_frame6, text="Select", command=selectFolderPath6)
        ...
        image_label7 = tk.Label(image_frame7, text="Image path7")
        ...
        image_button7 = tk.Button(image_frame7, text="Select", command=selectFolderPath7)
        ...
        image_label8 = tk.Label(image_frame8, text="Image path8")
        ...
        image_button8 = tk.Button(image_frame8, text="Select", command=selectFolderPath8)
        ...
        image_label9 = tk.Label(image_frame9, text="Image path9")
        ...
        image_button9 = tk.Button(image_frame9, text="Select", command=selectFolderPath9)
    ...
    if True:
        ...
        if os.path.isfile(txtPath):
            os.remove(txtPath)
        f = open(txtPath, 'w')
        f.write("Finding image\nBut due to server error\nOnly hyperLink created\nImage didn't copy\n\nWrong File:\n\n")
    ...
    def HyperLinkBuilding(i):
        ...
        print(editWS.cell(row=i, column=nameCoordinate).value)
    ...
    def ImageCopy(i):
        ...
        if picPath[i - 10] != "Path":
            picName[i-10] = newTestName[i-10] + "_" + (excelPath.get()).split(")(")[0][-4:] + ".png"
            newPath_old = "Image/" + newImageFolder.split("/")[-1] + "/" + (picName[i - 10][:-4] + "_" + unit[-4:] + "_" + temp + ".png")
