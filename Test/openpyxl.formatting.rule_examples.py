...
#red_fill1 = PatternFill(bgColor="FF0000")
#dxf1 = DifferentialStyle(fill=red_fill)
rule1 = Rule(type="containsText", text="Passed", dxf=DifferentialStyle(fill=PatternFill("solid", bgColor='00B050'), alignment=alignment(horizontal='center', vertical='bottom')))
rule1.formula = ['NOT(ISERROR(SEARCH("Passed",F3)))']
ws.conditional_formatting.add('F3:F10', rule1)
#ws.conditional_formatting.add(cell1, Rule(type="containsText", text="Passed", dxf=DifferentialStyle(fill=PatternFill("solid", bgColor='00B050'))))
#ws.conditional_formatting.add(cell1, Rule(type="containsText", text="Failed", dxf=DifferentialStyle(fill=PatternFill("solid", bgColor='FF0000'))))
